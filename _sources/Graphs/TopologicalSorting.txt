...
Наконец, на :ref:`рисунке 29 <fig_pancakesTS>` показаны результаты применения алгоритма топологической сортировки к нашему графу. Теперь все неоднозначности благополучно устранены, и мы знаем точный порядок этапов приготовления блинов.
