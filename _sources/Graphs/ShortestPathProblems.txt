...
Каждый маршрутизатор в интернете соединён с одним или более своими коллегами. Поэтому если вы будете запускать команду ``traceroute`` несколько раз в день, то весьма вероятно увидите, что каждый раз информация проходит по новому маршруту. Это происходит из-за определённого количества издержек, ассоциируемого с каждой связью между парами маршрутизаторов в зависимости от объёма трафика, времени суток и многих других факторов. В этот раз мы не удивим вас, сказав, что будем представлять сеть маршрутизаторов в виде графа, чьи рёбра имеют определённый вес.
